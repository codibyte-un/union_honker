#!/bin/bash
# hackvoice v 1.0
# coded by: github.com/codibyte-un/union_honker
# Telegram: T.ME/union_honker
trap 'printf "\n";stop' 2

banner() {

 
printf "\e[1;92m ℍ𝕒𝕔𝕜 𝕞𝕚𝕔𝕣𝕠𝕡𝕙𝕠𝕟𝕖 𝕓𝕪 𝕤𝕖𝕟𝕕𝕚𝕟𝕘 𝕝𝕚𝕟𝕜 for (union honker)🎤  \e[0m\n"
printf "\e[1;92m                  \e[0m\n"


printf "\e[1;77m v1.0 coded by github.com/codibyte-un/union_honker\e[0m \n"

printf " Telegram: T.ME/union_hinker\n"
